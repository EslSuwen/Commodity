...
namespace Commodity.Supplier
{
    public partial class AddSupplier : Form
    {
        ...
        {
            conn.Open();
            String sql = "insert into Supplier(sname,contacts,phone,synopsis) values (@sname,@contacts,@phone,@synopsis)";
            try
            {
                SqlCommand cmd = new SqlCommand(sql, conn);
                cmd.Parameters.Add(new SqlParameter("@sname", sname.Text));
                cmd.Parameters.Add(new SqlParameter("@contacts", contacts.Text));
                cmd.Parameters.Add(new SqlParameter("@phone", phone.Text));
                cmd.Parameters.Add(new SqlParameter("@synopsis", synopsis.Text));
